...
void CollisionManager::CollisionCheckObject(Object *dObjectA, Object *ObjectB)
{
	...
	if (collisionA.CollisionTime < 1.0f)
	{
		...
		// End Xu ly ngoai le
		dObjectA->HandlerCollision(collisionA);
		ObjectB->HandlerCollision(collisionB);
	}
}

void CollisionManager::CollisionCheckWithBulletObject(Object *dObjectA, TankBullet *ObjectB)
{
	...
	if (collisionA.CollisionTime < 1.0f)
	{
		...
		// End Xu ly ngoai le
		dObjectA->HandlerBulletCollision(collisionA,ObjectB->TankID,ObjectB->TankType);
		ObjectB->HandlerCollision(collisionB);
	}
}
