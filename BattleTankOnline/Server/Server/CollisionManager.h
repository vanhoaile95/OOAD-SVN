...
public:
	...
	static void CollisionCheckObject(Object * dObjectA, Object * ObjectB,int sid);

	static void CollisionCheckWithBulletObject(Object * dObjectA, TankBullet * ObjectB,int sid);
};
